...
class CustomHead(torch.nn.Module):
    ...
    def __init__(self, in_features: int, out_features: int, dropout_1=0.2, dropout_2=0.1):
        super().__init__()
        self.linear_1 = torch.nn.Linear(in_features=in_features, out_features=in_features)
        self.linear_2 = torch.nn.Linear(in_features=in_features, out_features=out_features)
        self.dropout1 = torch.nn.Dropout(dropout_1)
        self.dropout2 = torch.nn.Dropout(dropout_2)
